...
@Suite("AirtableFormulaBuilder")
struct AirtableFormulaBuilderTests {
        @Test func testProducesAirtableFriendlyStrings() {
        ...
        @Test func testCombinesFormulasWithAndOrNot() {
        ...
        @Test func testEscapesApostrophesInInterpolation() {
